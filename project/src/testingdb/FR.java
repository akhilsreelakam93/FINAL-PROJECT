...
//                    }
    ...
    public int compareImage(String imag1,String image2){
            ...
            node[] graph1=
                    genGraph(
                            getCN(
                                    getFastParallelAlgoSkeleton(
                                            binarizing(
                                                    ImageIO.read(new File(imag1))))));
            
            
          
                System.out.println("Comparing Samples.........Please wait");
                        val = compare(graph1,
                                genGraph(
                                        getCN(
                                                getFastParallelAlgoSkeleton(
        ...
        //System.out.println("Fingerprint comparison value: "+val);
        return val;
    }
